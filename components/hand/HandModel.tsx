...
function useMats(){
 const m=useMemo(()=>{
  ...
  return {t,glove:M({color:'#1a1a1a',roughness:.92,metalness:0,bumpMap:t,bumpScale:.8}),edge:M({color:'#222',roughness:.95}),
   skin:new THREE.MeshPhysicalMaterial({color:'#c68642',roughness:.65,sheen:.6,sheenColor:new THREE.Color('#ff9a7a'),sheenRoughness:.5}),
   strip:M({color:'#8B6914',roughness:.4,metalness:.3}),contact:M({color:'#C8A84B',roughness:.3,metalness:.5}),nail:M({color:'#e8d5c0',roughness:.3,metalness:.05}),
